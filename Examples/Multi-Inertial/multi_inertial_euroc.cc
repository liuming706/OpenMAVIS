...
void LoadImages(const string &strPathLeft, const string &strPathRight,
                const string &strPathSideLeft, const string &strPathSideRight,
...
int main(int argc, char **argv) {
  ...
  for (seq = 0; seq < num_seq; seq++) {
    ...
    string pathCam0 = pathSeq + "/mav0/cam2/data";  // Left Camera
    string pathCam1 = pathSeq + "/mav0/cam3/data";  // Right Camera
    string pathCam2 = pathSeq + "/mav0/cam0/data";  // SideLeft Camera
    string pathCam3 = pathSeq + "/mav0/cam1/data";  // Sideright Camera
    string pathImu = pathSeq + "/mav0/imu0/data.csv";
    LoadImages(pathCam0, pathCam1, pathCam2, pathCam3, pathTimeStamps,
               vstrImageLeft[seq], vstrImageRight[seq], vstrImageSideLeft[seq],
               vstrImageSideRight[seq], vTimestampsCam[seq]);
    cout << "LOADED!" << endl;
  ...
  for (seq = 0; seq < num_seq; seq++) {
    ...
    for (int ni = 0; ni < nImages[seq]; ni++, proccIm++) {
      ...
      imSideRight =
          cv::imread(vstrImageSideRight[seq][ni], cv::IMREAD_UNCHANGED);
      ...
      Sophus::SE3f Twb = SLAM.TrackMulti(imLeft, imRight, imSideLeft,
                                         imSideRight, tframe, vImuMeas);
      // std::cout << "Twb SE3 transform:\n" << Twb.matrix() << std::endl;
#ifdef COMPILEDWITHC11
